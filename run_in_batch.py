        ...
        try:
            ...
            for i, output_ids in enumerate(outputs):
                ...
                try:
                    ...
                    compile_ok = os.path.exists("generated_code/clean_code.out") and result.returncode == 0
                    if not compile_ok:
                ...
                if os.path.exists(feedback_file):
                    ...
                    # Detect presence of warnings or alerts
                    lowered = content.lower()
                    if any(kw in lowered for kw in ["alert", "warning", "vulnerability", "error:", "cpp/"]):
                        security_err = True
